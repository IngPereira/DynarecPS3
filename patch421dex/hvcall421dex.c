...
void hvsc_redirect421dex(uint8_t hvcall, uint8_t opt)
{
    int x;
...
int lv1_write_htab_entry421dex(uint64_t vas_id, uint64_t slot, uint64_t va, uint64_t pa)
{
    hvsc_redirect421dex(1,1);	// redirect to hvcall 1
	...
	hvsc_redirect421dex(1, 0); // Now remove hvsc redirections
